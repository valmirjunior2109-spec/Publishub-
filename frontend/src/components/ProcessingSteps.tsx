...
export function ProcessingSteps({ status, step }: { status: AnalysisStatus; step: AnalysisStep }) {
  ...
  return (
    <Card className="flex flex-col gap-6" aria-live="polite">
      <div>
        ...
        <h2 className="mt-2 font-display text-[26px] font-medium tracking-tight">{status === "pending" ? t("queuedTitle") : t("title")}</h2>
