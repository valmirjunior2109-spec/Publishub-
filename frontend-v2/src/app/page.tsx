...
function Divider() {
  return (
    <div className="mx-auto max-w-page px-5" aria-hidden="true">
  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="mx-auto grid max-w-page gap-12 px-5 pb-16 pt-14 lg:grid-cols-[7fr_5fr] lg:gap-16 lg:pt-20">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/signup" className={buttonClasses("primary", "md", "min-h-11 px-6")}>
                {t("hero.cta")}
              </Link>
              <a href="#como-funciona" className={buttonClasses("secondary", "md", "min-h-11 px-6")}>
                {t("hero.secondary")}
              </a>
            </div>
          </div>
          ...
          <figure className="lg:pt-2">
            ...
            <figcaption className="mt-4 border-l border-ink pl-4">
        ...
        <section id="como-funciona" className="mx-auto max-w-page px-5 py-16 lg:py-20">
          ...
          <ol className="mt-10 flex flex-col">
            ...
            <li className="grid gap-4 border-t border-line py-8 md:grid-cols-12">
              ...
              <div className="md:col-span-5">
                ...
                <p className="mt-4 font-display text-[88px] font-bold leading-none tracking-[-0.03em] sm:text-[112px]">{dropTime}</p>
            ...
            <li className="grid gap-4 border-t border-b border-line py-8 md:grid-cols-12">
              ...
              <div className="rounded-md border border-[rgba(180,71,44,0.25)] bg-accent-soft p-6 md:col-span-6 md:col-start-7">
        ...
        {/* ---------- o loop ---------- */}
        <section className="mx-auto grid max-w-page gap-10 px-5 py-16 lg:grid-cols-[5fr_7fr] lg:gap-16 lg:py-20">
          <div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="max-w-[58ch] text-[16px] leading-relaxed text-ink-muted">{t("loop.text2")}</p>
            <div className="mt-2 grid max-w-md grid-cols-2 gap-4 rounded-md border border-line bg-paper-raised p-5">
              <div>
                <p className="eyebrow">{t("loop.predicted")}</p>
                <p className="mt-2 font-display text-[44px] font-bold leading-none tabular-nums tracking-tight">72%</p>
              </div>
              <div>
                <p className="eyebrow">{t("loop.actual")}</p>
        ...
        {/* ---------- a oferta ---------- */}
        <section className="mx-auto max-w-page px-5 py-16 lg:py-20">
          <div className="grid gap-8 rounded-md border border-line bg-paper-raised p-7 sm:p-10 lg:grid-cols-[2fr_3fr] lg:items-center">
            <div>
            ...
            <div>
              ...
              <Link href="/planos" className={buttonClasses("primary", "md", "mt-6 min-h-11 px-6")}>
                {t("offer.cta")}
              </Link>
            </div>
          </div>
        ...
        {/* ---------- faq curto ---------- */}
        <section className="mx-auto grid max-w-page gap-8 px-5 pb-20 lg:grid-cols-[4fr_8fr]">
          <div>
            ...
            {(["1", "2", "3"] as const).map((n) => (
              <details key={n} className="group border-t border-line py-4 last:border-b">
                <summary className="flex items-center justify-between gap-4 text-[16px] font-medium">
                  {t(`faq.q${n}`)}
                  <span aria-hidden="true" className="text-xl font-light text-ink-muted transition-transform group-open:rotate-45">
                    +
                  </span>
                </summary>
        ...
        <footer className="border-t border-line">
          <div className="mx-auto flex max-w-page flex-wrap items-center justify-between gap-4 px-5 py-8">
